...
$user = mysqli_query($db,"SELECT * FROM international_student WHERE id = $user_id");
if ($user->num_rows > 0) {
...
if(isset($_POST['update_user'])){
    ...
    //$password3 = mysqli_real_escape_string($db,$_POST['password']);
        ...
        $query = "UPDATE `international_student` SET `First_name`='$firstName',`Last_name`='$lastName',`UserName`='$userName',
        `email`='$email',`phone_number`='$phoneNumber'  WHERE `id` = '$user_id'";
...
<html lang="en-US">
    ...
    <body>
        ...
        <form action="self_edit.php" method="post">
            <br><br>
            <div class="container">
