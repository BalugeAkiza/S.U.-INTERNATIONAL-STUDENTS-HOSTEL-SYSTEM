        ...
        <table class="table">
            ...
            <tbody>
                <?php
                    ...
                    $hostel = mysqli_query($db,"SELECT * FROM hostel WHERE suspend = 0");
                    if ($hostel->num_rows > 0) {
                        ...
                        while($row = $hostel->fetch_assoc()) {
                            echo '<tr>';
                                ...
                                echo '<td scope="row">'.$row["Number_of_People"].'</td>';
                                echo '<td scope="row"><a href="suspend.php?hostel_id='.$row["hostel_id"].'" class="btn btn-danger">Suspend Hostel</a></td>';
                                echo '<td scope="row"><a href="Edit_hostel.php?hostel_id='.$row["hostel_id"].'" class="btn btn-success">Edit</a></td>';
