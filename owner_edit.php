...
$user = mysqli_query($db,"SELECT * FROM hostel_owner WHERE owner_id = $owner_id");
if ($user->num_rows > 0) {
...
if(isset($_POST['update_owner'])){
    ...
    //$password3 = mysqli_real_escape_string($db,$_POST['password']);
        ...
        $query = "UPDATE `hostel_owner` SET `First_name`='$firstName',`Last_name`='$lastName',`
        UserName`='$userName',`phone_number`='$phoneNumber',`email`='$email' WHERE owner_id='$owner_id'";
...
<html lang="en-US">
    ...
    <body>
        ...
        <form action="owner_edit.php" method="post">
            <br><br>
            <div class="container">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <br><br>
                    <input type="hidden" name="owner_id" value="<?php echo $owner_id ?>"  required><br><br>
                    ...
                    <input type="text" name="user_name" value="<?php echo $UserName ?>" required><br><br>
                    ...
                    <input type="password"id="password" name="password" value="<?php// echo $password1 ?>" placeholder="enter the password" required><br><br>
                    ...
                    <input type="password" id="confirm" name="confirm"value="<?php //echo $password1 ?>"  placeholder="confirm password"><br><br>-->
